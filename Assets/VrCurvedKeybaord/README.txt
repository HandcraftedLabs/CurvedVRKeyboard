...
Starting:
 ...
 on it or add it to existing one. Next press no camera found button or drop camera from scene.
 Next create canvas and add UI text To it. You are ready to go.

Changing key colors:

 You can change color or transparency by editing materials in  
 VrCurvedKeybaord --> KeyboardResources --> Materials
 As you do with standard materials.
 
Changing keyDisplays:
 
 To change key displays go into
 VrCurvedKeybaord -->KeyboardResources --> Scripts --> KeyboardComponent 
