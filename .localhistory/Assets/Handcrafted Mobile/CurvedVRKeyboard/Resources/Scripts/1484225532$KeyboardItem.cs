...
namespace CurvedVRKeyboard {
    ...
    public class KeyboardItem: KeyboardComponent {
        ...
        public void ManipulateSpace ( KeyboardCreator creator, Sprite spaceSprite ) {
            ...
            if(spaceSprite != null) {
                AddSpriteToMaterials(spaceSprite);
            }
            if(meshCreator == null) {
        ...
        private void AddSpriteToMaterials ( Sprite spaceSprite ) {
            keyNormalMaterial = ChangeMaterialProperties(spaceSprite, keyNormalMaterial);
            keySelectedMaterial = ChangeMaterialProperties(spaceSprite, keySelectedMaterial);
            keyPressedMaterial = ChangeMaterialProperties(spaceSprite, keyPressedMaterial);
