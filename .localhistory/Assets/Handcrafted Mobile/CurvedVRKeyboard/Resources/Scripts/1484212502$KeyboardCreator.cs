    ...
    public class KeyboardCreator: KeyboardComponent {
        ...
        public void InitKeys () {
            if(keys == null) {
                ...
                KeyboardItem[] filtredKEys = new KeyboardItem[keys.Length - 1];
        ...
        public void ChangeMaterialOnKeys () {
            for(int i = 0;i < keys.Length;i++) {
                if(i != spaceKeyNumber) { 
                    keys[i].SetMaterials(KeyNormalMaterial, KeySelectedMaterial, KeyPressedMaterial);
                }
            }
        ...
        public void checkErrors () {
            ...
            if(keys[spaceKeyNumber].GetMeshName().Equals(MESH_NAME_SEARCHED)) {//are keys positioned corectly
        ...
        public Sprite SpaceSprite {
            ...
            set {
                if(spaceSprite != value && value == null) { //if new null
                    spaceSprite = value;
                    keys[spaceKeyNumber].ManipulateSpace(this, SpaceSprite);
                } else if(spaceSprite != null) {
