...
namespace CurvedVRKeyboard {
    ...
    public class KeyboardCreator: KeyboardComponent {
        ...
        private const int excludedKey = 28;
        ...
        public void checkErrors () {
            ...
            if(keys[excludedKey].GetMeshName().Equals(MESH_NAME_SEARCHED)) {//are keys positioned corectly
        ...
        public Sprite SpaceSprite {
            ...
            set {
                if(spaceSprite != value && value == null) { //if new null
                    spaceSprite = value;
                    keys[excludedKey].ManipulateSpace(this, SpaceSprite);
